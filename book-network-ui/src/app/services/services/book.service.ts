...
import { approveBorrowedBookReturn } from '../fn/book/approve-borrowed-book-return';
import { ApproveBorrowedBookReturn$Params } from '../fn/book/approve-borrowed-book-return';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `approveBorrowedBookReturn()` */
  static readonly ApproveBorrowedBookReturnPath = '/books/borrow/return/approve/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `approveBorrowedBookReturn()` instead.
   *
   * This method doesn't expect any request body.
   */
  approveBorrowedBookReturn$Response(params: ApproveBorrowedBookReturn$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return approveBorrowedBookReturn(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `approveBorrowedBookReturn$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  approveBorrowedBookReturn(params: ApproveBorrowedBookReturn$Params, context?: HttpContext): Observable<number> {
    return this.approveBorrowedBookReturn$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
