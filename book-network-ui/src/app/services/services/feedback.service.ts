...
import { PageResponseFeedbackResponses } from '../models/page-response-feedback-responses';
...
export class FeedbackService extends BaseService {
   ...
   */
  findAllFeedbacksByBook$Response(params: FindAllFeedbacksByBook$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseFeedbackResponses>> {
   ...
   * This method doesn't expect any request body.
   */
  findAllFeedbacksByBook(params: FindAllFeedbacksByBook$Params, context?: HttpContext): Observable<PageResponseFeedbackResponses> {
    return this.findAllFeedbacksByBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<PageResponseFeedbackResponses>): PageResponseFeedbackResponses => r.body)
    );
  }
